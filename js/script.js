/*
   Arquivo JavaScript principal para o portfólio pessoal
   Desenvolvido para a disciplina Ferramentas de Desenvolvimento Web - UNINTER
   Autor: João Silva
*/
...
/**
 * Funções para demonstração de projetos (chamadas pelos links)
 */
function showProjectDemo(projectType) {
    const messages = {
        'landing': 'Demo da Landing Page: Uma página moderna e responsiva com animações suaves e design atrativo.',
        'todo': 'Demo do App de Tarefas: Aplicação funcional para gerenciar tarefas com localStorage.',
        'tictactoe': 'Demo do Jogo da Velha: Jogo interativo com detecção de vitória e interface intuitiva.',
        'calculator': 'Demo da Calculadora: Calculadora funcional com operações básicas e design moderno.'
    };
...
function showProjectCode(projectType) {
    const messages = {
        'landing': 'Código da Landing Page: HTML semântico, CSS com Flexbox/Grid e JavaScript para interações.',
        'todo': 'Código do App de Tarefas: Manipulação do DOM, eventos e armazenamento local.',
        'tictactoe': 'Código do Jogo da Velha: Lógica de jogo, arrays bidimensionais e algoritmos de vitória.',
        'calculator': 'Código da Calculadora: Operações matemáticas, validação de entrada e tratamento de erros.'
    };
...
function initializeAnimations() {
    ...
    const animatedElements = document.querySelectorAll('.hobby-card, .course-card, .project-card, .academic-card, .language-card, .availability-item');
